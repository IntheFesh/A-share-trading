...
MODULES = [
    ...
    "trading_system.data.collectors.synthetic",
    "trading_system.data.collectors.baostock_collector",
    "trading_system.data.collectors.tushare_collector",
    "trading_system.data.schema",
    "trading_system.data.fetch_training_data",
    # features / regime / triggers / labels(Phase 1)
    "trading_system.features",
    "trading_system.features.builtin.families",
